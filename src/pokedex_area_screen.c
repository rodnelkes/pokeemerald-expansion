...
static bool8 MonListHasSpecies(const struct WildEncounterTypes *types, u16 species, enum WildPokemonArea area)
{
    u16 i, size;
    ...
    switch(area){
        case WILD_AREA_WATER:
            info = types->waterMonsInfo;
            size = WATER_WILD_COUNT;
            break;
        case WILD_AREA_ROCKS:
            info = types->rockSmashMonsInfo;
            size = ROCK_WILD_COUNT;
            break;
        case WILD_AREA_FISHING:
            info = types->fishingMonsInfo;
            size = FISH_WILD_COUNT;
            break;
        case WILD_AREA_LAND:
            info = types->landMonsInfo;

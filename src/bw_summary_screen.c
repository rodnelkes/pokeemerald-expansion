...
static bool8 DecompressGraphics(void)
{
    ...
    case 1:
        ...
        {
            FastLZ77UnCompWram(sSummaryPage_Info_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_INFO]);
            sMonSummaryScreen->switchCounter++;
        }
        break;
    case 2:
        FastLZ77UnCompWram(sSummaryPage_Skills_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_SKILLS]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 3:
        FastLZ77UnCompWram(sSummaryPage_BattleMoves_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_BATTLE_MOVES]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 4:
        FastLZ77UnCompWram(sSummaryPage_ContestMoves_Tilemap_BW, sMonSummaryScreen->bg2TilemapBuffers[PSS_PAGE_CONTEST_MOVES]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 5:
        FastLZ77UnCompWram(sSummaryEffect_Battle_Tilemap_BW, sMonSummaryScreen->bg1TilemapBuffers[PSS_EFFECT_BATTLE]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 6:
        FastLZ77UnCompWram(sSummaryEffect_Contest_Tilemap_BW, sMonSummaryScreen->bg1TilemapBuffers[PSS_EFFECT_CONTEST]);
        sMonSummaryScreen->switchCounter++;
        break;
    case 7:
        FastLZ77UnCompWram(sSummaryPage_ScrollBG_Tilemap_BW, sMonSummaryScreen->bg3TilemapBuffers);
        sMonSummaryScreen->switchCounter++;
        break;
    case 8:

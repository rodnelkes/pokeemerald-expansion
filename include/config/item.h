...
#define I_EXP_SHARE_FLAG        FLAG_ITEM_EXP_SHARE // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    VAR_ITEM_LAST_REPEL_LURE_USED // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        FLAG_ITEM_VS_SEEKER_CHARGING // If this flag is assigned, the Vs Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working.

...
#define FLAG_DEXNAV_SEARCHING           0x20 // Previously Unused Flag
#define FLAG_DEXNAV_GET                 0x21 // Previously Unused Flag
#define FLAG_DEXNAV_DETECTOR_MODE       0x22 // Previously Unused Flag
#define FLAG_BATTLE_SMART_WILD_AI       0x23 // Previously Unused Flag
#define FLAG_BATTLE_DYNAMAX             0x24 // Previously Unused Flag
#define FLAG_BATTLE_TERA_ORB_CHARGED    0x25 // Previously Unused Flag
#define FLAG_ITEM_EXP_SHARE             0x26 // Previously Unused Flag
#define FLAG_ITEM_VS_SEEKER_CHARGING    0x27 // Previously Unused Flag
